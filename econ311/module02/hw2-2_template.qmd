...
- On the right hand side, there should be a checkbox that says "Display Base Period". Make sure this is checked!
</ol>
...
`r q <- q+1; letters[q]`. Make a new column that is the z-score for each observation. Use the 1901-2000 average as the mean in the calculation.^[The 1901-2000 average can be found on NOAA. Click on the checkbox that says "Display Base Period", then click "Plot". This should add a horizontal line with a long-run average. Use this number in your calculation.] (**2 Points**)
