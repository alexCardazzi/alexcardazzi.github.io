...
For this homework, we will examine NFL draft pick compensation from 2002 to 2017 for players drafted in the 1st through 3rd rounds. These data be obtained via [this link](https://alexcardazzi.github.io/econ400/data/nfl_draft_data.csv).  A description of the variables are as follows:
